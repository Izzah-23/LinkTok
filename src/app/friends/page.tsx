      ...
      <div className="container mx-auto p-4 grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="col-span-1 md:col-span-2 space-y-4">
          ...
          <input
            ...
            className="w-full md:w-3/4 p-3 border rounded-md shadow-md focus:outline-none focus:ring-2 focus:ring-black"
          />
          {/* User cards */}
            ...
            <div key={result.id} className="bg-white p-4 rounded-lg shadow-md flex items-center space-x-4">
              ...
              {followStatus[result.id] ? (
                <button
                  ...
                  className="px-4 py-2  bg-orange-600 text-white rounded-md shadow-md hover:bg-red-400 hover:text-black 
